# TODO: Translation updated at 2020-05-24 21:50

translate catalan strings:

    # game/screens/chapter4/femiblog.rpy:21
    old "FEMIBLOG"
    new "FEMIBLOG"

    # game/screens/chapter4/femiblog.rpy:31
    old "FEMINET"
    new "FEMINET"

    # game/screens/chapter4/femiblog.rpy:42
    old "www.femiblog.cat/home"
    new "www.femiblog.cat/home"

    # game/screens/chapter4/femiblog.rpy:59
    old "{i}Feministing{/i}"
    new "{i}Feministing{/i}"

    # game/screens/chapter4/femiblog.rpy:77
    old "{i}#EverydaySexism{/i}"
    new "{i}#EverydaySexism{/i}"

    # game/screens/chapter4/femiblog.rpy:95
    old "{i}#BringBackOurGirls{/i}"
    new "{i}#BringBackOurGirls{/i}"

    # game/screens/chapter4/femiblog.rpy:112
    old "{i}The Hunting Ground{/i}"
    new "{i}The Hunting Ground{/i}"

    # game/screens/chapter4/femiblog.rpy:127
    old "Recolza la causa"
    new "Recolza la causa"

    # game/screens/chapter4/femiblog.rpy:147
    old "Malala Yousafzai i l’educació global"
    new "Malala Yousafzai i l’educació global"

    # game/screens/chapter4/femiblog.rpy:169
    old "El feminisme universal"
    new "El feminisme universal"

    # game/screens/chapter4/femiblog.rpy:188
    old "Feminisme anticapitalista"
    new "Feminisme anticapitalista"

    # game/screens/chapter4/femiblog.rpy:206
    old "El sistema prostitucional i el mercat dels desitjos"
    new "El sistema prostitucional i el mercat dels desitjos"

    # game/screens/chapter4/femiblog.rpy:50
    old "Internet i les xarxes socials han permès organitzar i promoure protestes. Per una banda, és una eina empoderadora perquè permet conscienciar a les persones, realitzar una gestió comunitària, i una major accessibilitat i rapidesa, però d’altra banda, és perjudicial perquè es poden donar casos de {i}trolling{/i} (publicacions amb missatges incendiaris pensats per provocar odi), {i}doxxing{/i} (publicar dades personals per incitar a la intimidació i l’assetjament), {i}amenaces de violació i mort{/i}, i {i}pornografia venjativa{/i} (publicació de fotos o vídeos íntims d’una persona a Internet sense el seu coneixement ni consentiment)."
    new "Internet i les xarxes socials han permès organitzar i promoure protestes. Per una banda, és una eina empoderadora perquè permet conscienciar a les persones, realitzar una gestió comunitària, i una major accessibilitat i rapidesa, però d’altra banda, és perjudicial perquè es poden donar casos de {i}trolling{/i} (publicacions amb missatges incendiaris pensats per provocar odi), {i}doxxing{/i} (publicar dades personals per incitar a la intimidació i l’assetjament), {i}amenaces de violació i mort{/i}, i {i}pornografia venjativa{/i} (publicació de fotos o vídeos íntims d’una persona a Internet sense el seu coneixement ni consentiment)."

    # game/screens/chapter4/femiblog.rpy:50
    old "No obstant això, hem decidit retre homenatge amb aquest blog a les germanes Jessica i Vanessa Valentí, creadores del blog {i}Feministing{/i} (2004), en el qual reunien un ampli ventall de veus femenines. Aquest blog incloïa articles d’actualitat i anàlisi en profunditat i posterior secció de comentaris, i fòrums de discussió. En aquest sentit, va contribuir a la visibilitat dels assumptes feministes."
    new "No obstant això, hem decidit retre homenatge amb aquest blog a les germanes Jessica i Vanessa Valentí, creadores del blog {i}Feministing{/i} (2004), en el qual reunien un ampli ventall de veus femenines. Aquest blog incloïa articles d’actualitat i anàlisi en profunditat i posterior secció de comentaris, i fòrums de discussió. En aquest sentit, va contribuir a la visibilitat dels assumptes feministes."

    # game/screens/chapter4/femiblog.rpy:50
    old "feministing"
    new "feministing"

    # game/screens/chapter4/femiblog.rpy:68
    old "Les dones del món comparteixen les seves experiències del sexisme. Dones de totes les edats, classes, races. Es preté legitimar la sensació d’agreujament de les dones. Es mostra l’omnipresència del sexisme i la normalització social de les seves formes menors, que acostumen a considerar-se trivials, que permet prosperar a la misoginia subjacent en els casos més greus d’abús i opressió. Segons Laura Bates, la lluita contra el sexisme actualment no és assumpte solament d’homes, sinó de persones contra prejudicis."
