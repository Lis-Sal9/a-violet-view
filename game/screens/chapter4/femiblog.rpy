...
screen femiblog:
    ...
    fixed:
        ...
        imagebutton:
            ...
            content_1="No obstant això, hem decidit retre homenatge amb aquest blog a les germanes Jessica i Vanessa Valentí, creadores del blog {i}Feministing{/i} (2004), en el qual reunien un ampli ventall de veus femenines. Aquest blog incloïa articles d’actualitat i anàlisi en profunditat i posterior secció de comentaris, i fòrums de discussió. En aquest sentit, va contribuir a la visibilitat dels assumptes feministes.",
        ...
        imagebutton:
            ...
            action [Hide("femiblog"), SetVariable("femiblog_post_active", True), Show(
                ...
                path="malala-yousafzai-i-educacio-global")]
        ...
        imagebutton:
            ...
            content_1="De la mateixa manera, Kathi Weeks, en {i}The Problem with Work{/i} (2011), afirma que el moviment marxista i feminista han acceptat el treball remunerat com a mètode principal de la distribució d’ingressos. És per aquest motiu que proposa una sociedad {i}postlaboral{/i} en la qual totes les persones mantingudes per l’Estat produeixen per sí mateixes, resultant-ne un enriquiment cultural. El treball és una institució que pot i ha de ser qüestionada.",
            image_0="images/chapter4/femiblog/meat.jpg",
            image_1="images/chapter4/femiblog/problem.jpg",
            x_0=400, y_0=600, x_1=400, y_1=600,
            path="feminisme-anticapitalista")]
        ...
        imagebutton:
            ...
            x_1=400, y_1=600,
            path="el-sistema-prostitucional-i-el-mercat-dels-desitjos")]
