...
init -10 python:
    glossary_dict_en = {
        ...
        15: {
            ...
            "content": "Hedvig Charlotta Nordenflycht, Swedish writer and intellectual, debuted literily 1742 with {i}The Mourning Turtledove{/i} ({i}Den sörjande Turturduvan{/i}), in which she claimed for further rights for her own sex. Some years after that, in 1753 she was the first woman accepted within the {i}Tankebyggararorden{/i} ({i}Order of the thought constructors{/i}), a literary group in the city of Stockholm that aimed for a reform in the Swedish literature. With works such as {i}Women's duty to train their sense{/i} ({i}Fruentimbers Plikt att upöfwa deras Wett{/i}, 1744) to defend the women intellect or {i}To the Defense of Women{/i} ({i}Fruntimrens försvar{/i}, 1761) to disprove misogyny, she vindicated the right to be intellectualy active. She also signed its own works with her own birthname."
        },
        16: {
            "name": "Kimberlé Crenshaw",
            "content": "Specialist in critic theory of race, Kimberlé Crenshaw defined the term {i}intersectionality{/i}. In her 1991 essay, {i}Mapping the Margins: Intersectionality, Identity Polotics and Violence against Women of Color{/i}, she divided it into three types. Structural intersectionality refers to the different oppression exercised upon white women and upon black women. Political intersectionality is related to the impact of the law and public politics upon women of color, regardless if those are inspired in feminist or aniracist motivations. And finally, representative intersectionality refers to how women of color are represented in popular culture and how that affects in their daily lifes. This way, she establishes that the multiplicity of the oppression should not have an additive approach, but it should be understood how race complicates class oppression, gender complicates racial oppression, and so on."
        },
        17: {
            "name": "{i}La Liberté guidant le peuple{/i}",
            "content": "The painting {i}Liberty Leading the People{/i} ({i}La Liberté guidant le peuple{/i}) was painted by Eugène Delacroix to represent Liberty as a guide who leads the people, formed by middle and lower social class members, in July 28th during the Revolution of the {i}Three Glorious{/i} ({i}Trois Glorieuses{/i}). In this way, the idea of liberty is represented by a woman gifted with great beauty."
        },
        18: {
