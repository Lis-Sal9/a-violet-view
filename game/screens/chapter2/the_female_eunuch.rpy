...
screen the_female_eunuch():
    imagemap:
        idle "images/chapter2/hostel/pizzey_hostel_room.png"
        ground "images/chapter2/hostel/pizzey_hostel_room.png"
        hotspot (897, 664, 171, 18):
            clicked [Function(addEunuch), Hide("the_female_eunuch"), Hide("hover_eunuch")]
            hovered ShowTransient("hover_eunuch", img="images/chapter2/hostel/pizzey_hostel_room_hover.png")
